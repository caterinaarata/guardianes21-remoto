...
public class Main extends ApplicationAdapter {
    ...
    private float posYPersonaje = 350;
    ...
    public void create() {
        ...
        personajeWalk[0] = new Texture("characters/player/guardian/walk/walk_1.jpg");
        personajeWalk[1] = new Texture("characters/player/guardian/walk/walk_2.jpg");
        personajeWalk[2] = new Texture("characters/player/guardian/walk/walk_3.jpg");
        personajeWalk[3] = new Texture("characters/player/guardian/walk/walk_4.jpg");
        ...
        personajeJump[0] = new Texture("characters/player/guardian/jump/jump_1.jpg");
        personajeJump[1] = new Texture("characters/player/guardian/jump/jump_2.jpg");
        personajeJump[2] = new Texture("characters/player/guardian/jump/jump_3.jpg");
